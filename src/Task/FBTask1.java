package Task;
	...
	driver.findElement(By.xpath("//input[@name='firstname'][1]")).sendKeys("Kartik");
	Thread.sleep(1000);
	driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Gupta");
	Thread.sleep(1000);
	driver.findElement(By.xpath("(//input[@type='text'])[3]")).sendKeys("kartikgupta357@gmail.com");
	Thread.sleep(1000);
	driver.findElement(By.xpath("(//input[@type='text'])[4]")).sendKeys("kartikgupta357@gmail.com");
	Thread.sleep(1000);
	driver.findElement(By.xpath("//input[@type='password']")).sendKeys("8");
	Thread.sleep(1000);
